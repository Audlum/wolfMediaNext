                    ...
                    <div className={css.rectangleBottom}>
                        ...
                        <div className={css.whiteBlock}>
                            <div className={css.moreBlock}>
                                <Image src={item.moreImgFirst} width={80} height={80} alt=""/>
                                <p>{item.moreTitleFirst}</p>
                            </div>
                            <div className={css.moreBlock}>
                                <Image src={item.moreImgSecond} width={80} height={80} alt=""/>
                                <p>{item.moreTitleSecond}</p>
                            </div>
                            <div className={css.moreBlock}>
                                <Image src={item.moreImgThird} width={80} height={80} alt=""/>
